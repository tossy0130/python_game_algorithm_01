...
def main():
    ...
    if proc==0:
        ...
        proc=1
    if proc==1:
        cvs.create_text(780, 580, text="1枚目をめくってください")
    if proc==2:
        cvs.create_text(780, 580, text="2枚目をめくってください")
    if proc==3 and tmr==15: # 揃ったか判定
    ...
    if proc==6 and tmr==15: # 揃ったか判定
        ...
        tmr = 0
    if proc==7:
        cvs.create_text(780, 580, text="終了です")
    root.after(200, main)
